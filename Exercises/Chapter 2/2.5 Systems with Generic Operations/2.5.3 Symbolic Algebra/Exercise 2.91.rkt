...
(define (install-polynomial-package)
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;; TERM LIST REPRESENTATION: SPARSE ;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;; TERM LIST REPRESENTATION: DENSE ;;;;;;;;;;;;;;;;;;;;;;;;;;;
              ...
              (let ((new-c (div (coeff t1) (coeff t2)))
                ...
                (let ((new-term
                  ...
                  (let ((new-L1
                         (sub-terms
                          L1
                          (mul-terms (list new-term) L2))))
                    (let ((rest-of-result
                           (div-terms new-L1 L2)))
                      (let ((final-quotient (add-terms new-term rest-of-result))
                            (final-remainder '()))
                        (list final-quotient final-remainder)
                      )))))))))
...
(define a-p (make-polynomial 'x (list (list 5 1) (list 0 -1))))
(define b-p (make-polynomial 'x (list (list 2 1) (list 0 -1))))
